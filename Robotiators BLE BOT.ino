int forwardRight = 11;   //right motor, forward action
int forwardLeft = 10;    //left motor, forward action
int backwardRight = 9;   //right motor, backward action
...
void loop()
{
  while(1)    //for making sure that the loop doesn't break
  {
